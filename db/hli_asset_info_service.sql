...
--
-- Table structure for table `info_service`
--
...
CREATE TABLE `info_service` (
  `app_idx` int NOT NULL AUTO_INCREMENT,
  `app_group` varchar(45) DEFAULT NULL,
  `app_domain` varchar(45) DEFAULT NULL,
  `app_appcode` varchar(45) DEFAULT NULL,
  `app_name` varchar(45) DEFAULT NULL,
  `app_servicecode` varchar(45) DEFAULT NULL,
  `app_comment` longtext,
  `app_importance` varchar(10) DEFAULT '일반' COMMENT '서비스 중요도 (일반, 중요, 핵심)',
  PRIMARY KEY (`app_idx`)
